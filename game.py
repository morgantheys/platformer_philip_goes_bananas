...
# Fonts
FONT_SM = pygame.font.Font("assets/fonts/el_tercer_hombre.ttf", 32)
FONT_MD = pygame.font.Font("assets/fonts/el_tercer_hombre.ttf", 64)
FONT_LG = pygame.font.Font("assets/fonts/el_tercer_hombre.ttf", 72)
...
# Images
splash_screen = load_image("splashscreen.png", 1216, 640)

hero_walk1 = load_image("assets/character/monkey.png")
hero_walk2 = load_image("assets/character/monkey.png")
hero_jump = load_image("assets/character/monkey.png")
hero_idle = load_image("assets/character/monkey.png")
hero_images = {"run": [hero_walk1],
               "jump": hero_jump,
               "idle": hero_idle}

block_images = {"TL": load_image("assets/tiles/jungle_pack_05.png"),
                "TM": load_image("assets/tiles/jungle_pack_05.png"),
                "TR": load_image("assets/tiles/jungle_pack_05.png"),
                "ER": load_image("assets/tiles/jungle_pack_05.png"),
                "EL": load_image("assets/tiles/jungle_pack_05.png"),
                "TP": load_image("assets/tiles/jungle_pack_05.png"),
                "CN": load_image("assets/tiles/jungle_pack_05.png"),
                "LF": load_image("assets/tiles/jungle_pack_05.png"),
                "SP": load_image("assets/tiles/jungle_pack_05.png"),
                "WT": load_image("assets/tiles/water.jpg"),
                "CL": load_image("assets/tiles/white_cloud.png"),
                "SP": load_image("assets/tiles/space_tile.jpg"),
                "LB": load_image("assets/tiles/light_blue.png")}

coin_img = load_image("assets/coins/banana_coin.png")
star_coin_img = load_image("assets/coins/star_coin.png")
negative_coin_img = load_image("assets/coins/negative_coin.png")
death_coin_img = load_image("assets/coins/death_coin.png")
heart_img = load_image("assets/items/heart.png")
oneup_img = load_image("assets/items/oneup.png")
flag_img = load_image("assets/items/flag.png")
flagpole_img = load_image("assets/items/flagpole.png")

monster_img1 = load_image("assets/enemies/shark.png")
monster_img2 = load_image("assets/enemies/shark.png")
monster_images = [monster_img1]

bear_img = load_image("assets/enemies/dinosaur.png")
...
class Character(Entity):
    ...
    def process_star_coins(self, star_coins):
        hit_list = pygame.sprite.spritecollide(self, star_coins, True)

        for coin in hit_list:
            play_sound(COIN_SOUND)
            self.score += coin.value
            
    def process_negative_coins(self, negative_coins):
        hit_list = pygame.sprite.spritecollide(self, coins, True)
    ...
    #def process_powerdown(self, powerdown):
       # hit_list = pygame.sprite.spritecollide(self, powerdown, True)
    ...
    def update(self, level):
        ...
        if self.hearts > 0:
            ...
            #self.process_powerdowns(level.powerdowns)
...
class Star_Coin(Entity):
    def __init__(self, x, y, image):
        super().__init__(x, y, image)

        self.value = 10
        
class Negative_Coin(Entity):
    def __init__(self, x, y, image):
        super().__init__(x, y, image)

        self.value = -1

#class Powerdown(Entity):
    #def __init__(self, x, y, image):
       # super().__init__(x, y, image)
...
class Level():
    ...
    def __init__(self, file_path):
        ...
        self.starting_coins = []
        self.starting_star_coins = []
        #self.starting_powerdown = []
        self.starting_negative_coins = []
        ...
        self.negative_coins = pygame.sprite.Group()
        ...
        for item in map_data['star_coins']:
            x, y = item[0] * GRID_SIZE, item[1] * GRID_SIZE
            self.starting_coins.append(Star_Coin(x, y, star_coin_img))

        for item in map_data['negative_coins']:
            x, y = item[0] * GRID_SIZE, item[1] * GRID_SIZE
            self.starting_coins.append(Negative_Coin(x, y, negative_coin_img))

       # for item in map_data['powerdown']:
           # x, y = item[0] * GRID_SIZE, item[1] * GRID_SIZE
            #self.starting_coins.append(Powerdown(x, y, death_coin_img))
       ...
       # self.powerdowns.add(self.starting_powerdowns)
...
class Game():
    ...
    def display_splash(self, surface):
        surface.blit (splash_screen,(0,0))
    ...
    def display_stats(self, surface):
        level_text = FONT_SM.render("Level:" + str(self.level.name), 1, DARK_BLUE)
        hearts_text = FONT_SM.render("Hearts: " + str(self.hero.hearts), 1, DARK_BLUE)
        lives_text = FONT_SM.render("Lives: " + str(self.hero.lives), 1, DARK_BLUE)
        score_text = FONT_SM.render("Score: " + str(self.hero.score), 1, DARK_BLUE)

        surface.blit(score_text, (WIDTH - score_text.get_width() - 32, 32))
        surface.blit(level_text, (WIDTH - level_text.get_width() - 32, 64))
